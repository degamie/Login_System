...
public class AuthenticationController {
    ...
    public List<User>findByUserPasswword(String Passwword){//Finding User's Password
        return AuthenticationService.findByPasswword(Passwword);
    }
        public List<User>findByUserName(String username){
            return AuthenticationalService.findByUserName(username);
        }
    @Autowired
