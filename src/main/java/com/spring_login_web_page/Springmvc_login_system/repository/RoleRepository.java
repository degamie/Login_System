//WIP(29/3/2026)(Sarthak Mittal)#DegamieSign)#1.1.1.1
...
public interface RoleRepository extends JpaRepository<Role, Integer> {
    public List<Role>existsByPhoneNumeber(String PhoneNumber);
    public List<Role> updateByPhoneNumber(String PhoneNumber);//Updating Phonenumber in App
